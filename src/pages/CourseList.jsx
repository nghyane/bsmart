      ...
      <div className="col-lg-3 col-md-5">
        <div className="course-sidebar">
          ...
          <form action="#" method="post" className="category__course tag_r">
            ...
            {/* Show content */}
            <div id="showLvMobile" className="categories__course d-xs-none">
              ...
              <div
                id="showMore"
                onclick="showMoreLocal(`linhVuc`, `txtShowTitle`, `upIcon`, `downIcon`)"
              >
                <a className="txtShow">
                  {/* Xem thêm */}
                  <span id="txtShowTitle">Thu gọn</span>
                  <i
                    id="downIcon"
                    style={{ display: "none" }}
      ...
      <div className="col-lg-9 col-md-7">
        <div className="courses-list-content">
          <div className="header-courses-list">
            <div className="d-flex counter-course">
              <h5>0</h5>
              <p>Khoá học</p>
            </div>
